...
KEYWORDS_EXCLUDE = [
    ...
    "PlayStation", "PS6", "PS5", "PS4", "Xbox", "任天堂", "Nintendo", "Steam平台",
    # 게임 장르 / 플랫폼 출시 표현
...
KEYWORDS_EXCLUDE_COMPOUND: list[dict] = [
    {
        "comment": "索尼/Sony + PSN 게임 프로모션 → 제외 (카메라 브랜드 키워드 우회 차단)",
        "require_any": ["索尼", "sony"],
        "also_any": [
            "psn", "港服", "游戏促销", "游戏优惠", "游戏折扣",
            "限时特惠", "数字版游戏", "ps商店", "psn商店", "史低", "折扣游戏",
        ],
    },
    {
...
2. 가격 표기: 중국 위안(元/元/¥)은 반드시 '위안'으로 표기합니다. '원(₩)'으로 쓰지 마세요.
3. 国补(국가보조금): '국보(정부 보조금)'로 표기합니다.
4. 자연스러운 한국어 어순으로 재구성합니다 (예: "[제품명] [용량], [혜택] [가격]위안 — [칩셋] 탑재").
5. '폰' 대신 '스마트폰'을 사용합니다."""
